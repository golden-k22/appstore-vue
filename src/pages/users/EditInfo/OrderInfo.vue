  ...
  <div class="users-title_block Users-setting">
    <el-row>
      ...
      <div class="users-product-page-title">
        ...
        <label style="font-size:28px;">交易信息页</label>
      </div>
    </el-row>
    ...
    <div>
      <el-form label-position="right" label-width="150px" class="user_transaction_table">
            ...
            <template slot-scope="scope">
              <el-form>
                <div class="user-transaction-image">
                  <img src="../../../assets/Capture.jpg" class="user-transaction-image-size">
        ...
        >
          <!--Item Picture column-->
          <el-table-column label="商品照片" width="200" align="center">
            <template slot-scope="scope">
          ...
          <!--Item detail column-->
          <el-table-column label="商品名称/品牌" align="center">
            <template slot-scope="scope">
          ...
          <!--Attribute column-->
          <el-table-column prop="商品描述" label="Attribute" align="center"></el-table-column>

          <!--Account column-->
          <el-table-column prop="account" label="交易数量" align="center"></el-table-column>

          <!--Pay price column-->
          <el-table-column prop="成交价格" label="Pay Price" align="center">
            <template slot-scope="scope">
        ...
        <el-table :data="displayAddress" class="user-transactiion_table_size">
          ...
          <el-table-column prop="name" label="收货人姓名 " width="200" align="center"></el-table-column>
          <!--Phone number column-->
